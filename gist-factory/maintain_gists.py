...
def create_gists(
    ...
    for idx, item in enumerate(items, start=1):
        ...
        try:
            ...
            #       "language": "Python",
            #       "raw_url": "https://gist.githubusercontent.com/username/aa5a315d61ae9438b18d/raw/hello_world.py",
            #       "size": 160
            #     }
            #   },
            #   "public": false,
            ...
            #   "description": "Gist for hello_world.py",
            #   "comments": 0,
            #   "user": null,
            #   "owner": {
            #     "login": "username",
            ...
            if resp.status_code == 201:
                ...
                item.update({"id": gist_id, "operation": "created", "url": url})
                created_items.append(item)
                if debug:
                    print(f"✅ [{idx}] Created gist: {url}")
            else:
                print(
